...
public class LockscreenStyle extends AOKPPreferenceFragment
    ...
    private void updateLockSummary() {
        ...
        if (value == null) {
            ...
            resId = R.string.lockscreen_lock_icon_xenon;
    ...
    private void resizeSlimLock() {
        Bitmap slimLock = BitmapFactory.decodeResource(getResources(), R.drawable.xenon_lock);
        if (slimLock != null) {
            String path = null;
            int px = requestImageSize();
